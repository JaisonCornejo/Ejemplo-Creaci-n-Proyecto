...
void loop()
{
  ...
  sensorValue = analogRead(A0);//• Leer el potenciómetro a través del pin A0 de manera análoga.
...
Serial.print("sensor = ");
Serial.print(sensorValue);//-Sensor: Valor de lectura del análogo potenciómetro (valor entre 0-1023)

  Serial.print("\t output = ");
  Serial.println(outputValue);//-Salida: Valor de salida digital. 
